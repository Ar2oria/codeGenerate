...
function setDefaultValues() {
    $("#connection").val(getCookie("connection") != "" ? getCookie("connection") : "192.168.255.2");
    $("#port").val(getCookie("port") != "" ? getCookie("port") : "3306");
    $("#dataBase").val(getCookie("dataBase") != "" ? getCookie("dataBase") : "alpha_60");
    $("#userId").val(getCookie("userId") != "" ? getCookie("userId") : "alpha_dev");
    $("#userPass").val(getCookie("userPass") != "" ? getCookie("userPass") : "EJ82fVcH3h!K");
